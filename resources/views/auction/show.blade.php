            ...
            <div class="ms-3">
                ...
                <div class="d-flex flex-column bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                        <div>Trenutna ponuda: 189.88 RSD</div>
                       
                        <div class="input-group mb-3"> 
                            <input type="text" class="form-control" placeholder="Ponuda" aria-label="Example text with button addon" aria-describedby="button-addon1" style="border-color: #f79420;">
                            <button class="btn btn-outline-warning" type="button" id="button-addon1" style="border-color: #f79420;">Licitiraj</button>
                        </div>
                        <small class="text-muted ms-1">199.88 minumum</small>
                    </div>
                    <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                        ...
                        <div class="p-2 bd-highlight">14 ponuda</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column bd-highlight mb-3">
                      ...
                      <div class="row mb-2">
                        <div class="col">
                            <button type="button" class="btn btn-outline-warning w-100"><i class="bi bi-chat-square-dots"></i> Pitaj Prodavca</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn btn-outline-warning w-100"><i class="bi bi-shop-window"></i> Svi premeti Prodavca</button>
                        </div>
                    </div>
