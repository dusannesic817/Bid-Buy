            ...
            <div class="ms-3">
                ...
                <div class="d-flex flex-column bd-highlight mb-3">
                    ...
                    <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                        <div class="p-2 bd-highlight"><i class="bi bi-clock-fill" style="font-size: 20px; color:#b3c268"></i> 1 dan, 6 sati</div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <h5>Seller</h5>
                    <div class="d-flex flex-column bd-highlight mb-3">
                        <a href="##" style="text-decoration: none; "><div class="mb-2" style="font-size: 20px; color: #014675;"><i class="bi bi-person-fill" style="font-size: 24px; color:#b3c268"></i>{{$auction->user->username}}({{$count}})</div></a>
                      ...
                      <div class="row mb-2">
                        <div class="col">
                            <button type="button" class="custom-button w-100"><i class="bi bi-chat-square-dots"></i> Ask Saller</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <button type="button" class="custom-button w-100"><i class="bi bi-shop-window"></i> All seller items</button>
                        </div>
                    </div>
