    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            ...
            <div class="row item" style="height: 230px;">
                ...
                <div class="col-2">
                    <div class="mt-5">
                        <div><i class="bi bi-people-fill" style="font-size: 24px; color: rgb(132, 169, 202);"></i> 36 ponuda</div>
                        <div class="border-bottom mt-2 mb-2"></div>
                        <div><i class="bi bi-clock-fill" style="font-size: 24px; color: rgb(132, 169, 202);"></i> 3 dana</div>
                    </div>
                </div>
